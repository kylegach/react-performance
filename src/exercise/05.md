...
- How a common context pattern causes re-renders
- And how to optimize it to not do so with React.useMemo
- How and why to separate state from setter/dispatch provided via context
