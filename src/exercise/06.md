...
- Colocating state to reduce unnecessary re-renders
- Alternatively, using separate contexts
- Using a wrapping "man in the middle" component to grab relevant bits of state,
  making memoization more effective
- Higher-order components
- Extracting a shared HOC from a specific component
- Super-brief intro to Recoil
