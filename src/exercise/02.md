...
- React.useMemo API and when to use it
- Brief intro to Performance DevTools tab
  - Flame graph
  - Throttling
- Differences, re: dx & perf, in dev vs. prod builds
- Web workers, workerize webpack loader
